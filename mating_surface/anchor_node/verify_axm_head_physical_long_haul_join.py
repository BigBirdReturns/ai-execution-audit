...
def derive_predicates(value: dict[str, Any]) -> tuple[OrderedDict[str, bool], list[str], dict[str, Any]]:
    ...
    campaigns = [route["campaignId"], continuity["campaignId"], two_cell["campaignId"], successor["campaignId"], disposition["campaignId"]]
    auth_refs = [route["authorizationReceiptId"], continuity["authorizationReceiptId"], two_cell["authorizationReceiptId"], successor["authorizationReceiptId"]]
