...
def render_operator_script(config: Mapping[str, Any], paths: Mapping[str, str]) -> str:
    ...
    lines = [
        ...
        "",
        "# Transaction 01: exact private readiness census and declared artifact hashing.",
        ...
        "",
        "# Transaction 02: deterministic feed and resident-floor baseline.",
        ...
        "",
        "# Transaction 03: selected HALO3 audition.",
        ...
        "",
        "# HUMAN PHYSICAL CONTROL: perform the separately declared reversible HALO3 interruption here.",
        "# This script does not perform, infer, or attest that interruption.",
        "",
        "# Transaction 04: resident-floor continuity and comparison.",
        ...
        "",
        "# Transaction 05: offline input templates and cell-pair construction.",
        "& $Carrier template-inputs --out $Inputs --repository $Repo",
        "# HUMAN PRIVATE INPUT CONTROL: replace invented template bodies with the actual private campaign state before continuing.",
        ...
        "# HUMAN PHYSICAL CONTROL: move complete left and right bundles to distinct actual host classes and run verify-cell in private_local_attested mode on each host.",
        ...
        "",
        "# Transaction 06: cold-successor construction. Complete verification on the replacement HEAD class.",
        ...
        "# HUMAN PHYSICAL CONTROL: move the complete successor bundle to the replacement HEAD and run verify-successor in private_local_attested mode, supplying the original HEAD-class digest.",
        "",
        "# Transaction 07: compile all eight plan gates.",
        ...
        "",
        "# Transaction 08: admitted packet handoff. Execute only after conductor status closes flight_plan.",
        ...
        "",
        "# Continue the sixteen packet stages through the admitted packet runtime. Do not uncomment or batch-record stages without named-human confirmation and local evidence.",
        "# Seal only after nextStage is null:",
