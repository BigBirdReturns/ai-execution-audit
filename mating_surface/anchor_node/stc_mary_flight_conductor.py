...
def render_operator_script(config: Mapping[str, Any], paths: Mapping[str, str]) -> str:
    ...
    lines = [
        ...
        "    }",
        "    catch {",
        "        throw 'The selected readiness interpreter could not be started or observed.'",
        "    }",
        "    finally {",
        "        $process.Dispose()",
        "    }",
        ...
        "    if ($utf8.GetByteCount($probeStdout) -gt 65536) {",
        "        throw 'The selected readiness interpreter returned an oversized Torch probe.'",
        "    }",
        "    if ($utf8.GetByteCount($probeStderr) -gt 65536) {",
        "        throw 'The selected readiness interpreter returned oversized diagnostic output.'",
        "    }",
