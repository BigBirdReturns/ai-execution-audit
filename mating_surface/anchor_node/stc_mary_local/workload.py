...
def run_workload(args: Any) -> dict[str, Any]:
    ...
    if backend == "python":
        ...
        class_ids, counts, elapsed, backend_version, compute, device_class = classify_torch(feature_path, record_count, feature_count, class_count, weights, cuda=True, device_index=args.device_index)
