...
class AxmHeadPhysicalLongHaulJoinTests(unittest.TestCase):
    ...
    def test_profile_binds_supplier_conductor_floor_and_issue_37(self) -> None:
        ...
        self.assertEqual(sources["admittedConductor"]["commit"], "dd486472a8c610a20ee062dd6746c86fe8ede4b4")
    ...
    def test_final_conductor_source_and_lineage_are_exact(self) -> None:
