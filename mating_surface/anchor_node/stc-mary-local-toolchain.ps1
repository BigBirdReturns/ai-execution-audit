...
param(
    ...
    [ValidateSet('doctor', 'generate-feed', 'run-workload', 'verify-workload', 'compare-workloads', 'compile-plan', 'validate-profile')]
    [string]$Command,
...
$Script = Join-Path $PSScriptRoot 'stc_mary_local_toolchain.py'
if (-not (Test-Path -LiteralPath $Script -PathType Leaf)) {
    throw "Local toolchain script is absent: $Script"
}
